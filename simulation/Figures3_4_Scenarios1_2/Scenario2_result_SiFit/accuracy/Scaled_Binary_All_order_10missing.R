...
sifit_all_pair_result_form_0_1 = sprintf('/fs/project/kubatko.2-temp/gao.957/workspace/github_MO/Figures3_4_Scenarios1_2/Scenario2_result_SiFit/SiFit_SimulateData_10missing/summary/scaled_binary_ALL_order_matrix_alpha_0%s_beta_0%s.csv', alpha_str, beta_str)
