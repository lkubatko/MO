...
for (indexn in 1:1000){
  ...
  form = sprintf('/fs/project/kubatko.2-temp/gao.957/workspace/github_MO/Figures3_4_Scenarios1_2/Scenario2/RandomTree/RandomTree_%s.tre', indexn)
  sampletr=read.tree(form)
  
  sifit_tree_form_0_1 = sprintf('/fs/project/kubatko.2-temp/gao.957/workspace/github_MO/Figures3_4_Scenarios1_2/Scenario2/RandomTree/RandomTree_%s.tre', indexn)
  mat_sifit_tree_form_0_1 = read.tree(sifit_tree_form_0_1)
  
  sifit_br_form_0_1 = sprintf('/fs/project/kubatko.2-temp/gao.957/workspace/github_MO/Figures3_4_Scenarios1_2/Scenario2_result_SiFit/SiFit_SimulateData/SiFit_binary_alpha_0%s_beta_0%s_TrueTree/TrueTree_outcome_order_alpha_0%s_beta_0%s_matrix%s.txt.in.txt',alpha_str, beta_str, alpha_str, beta_str,indexn)
...
sifit_near_pair_result_form_0_1 = sprintf('/fs/project/kubatko.2-temp/gao.957/workspace/github_MO/Figures3_4_Scenarios1_2/Scenario2_result_SiFit/SiFit_SimulateData/summary/binary_near_order_matrix_alpha_0%s_beta_0%s.csv', alpha_str, beta_str)
