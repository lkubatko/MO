...
source("/fs/project/kubatko.2-temp/gao.957/workspace/github_MO/Figures3_4_Scenarios1_2/Scenario1_result/code_MO_ternary_function.R")
...
for(parameterIndex in 1:dim(parameter_setting)[1]){
  ...
  ternary_folder_form = sprintf('/fs/project/kubatko.2-temp/gao.957/workspace/github_MO/Figures3_4_Scenarios1_2/Scenario1_result/MO_Ternary_20missing/Ternary_alpha0%s_beta0%s_result',alpha_str, beta_str)
  ...
  for (indexn in 1:1000){
    ...
    obs_form = sprintf('/fs/project/kubatko.2-temp/gao.957/workspace/github_MO/Figures3_4_Scenarios1_2/Scenario1/SimulateData_New_20Missing/Ternary_alpha0%s_beta0%s/ternary_obs_0_1_tip_alpha_0%s_beta_0%s_matrix%s.csv', alpha_str, beta_str, alpha_str, beta_str,indexn)
    ...
    for(rownum in 1:dim(initial_obs_0_1)[1]){
      for(colnum in 1:dim(initial_obs_0_1)[2])
        ...
        }else if(initial_obs_0_1[rownum,colnum] == "2"){
          initial_obs_0_1_recode[rownum,colnum] = 2
        } else{
    ...
    for (i in 1:dim(initial_obs_0_1_recode)[1]){
      ...
      probs <- MO_ternary(alpha,beta,unit_theta,unit_gamma,unit_mu,initial_obs_0_1_recode[i,],sampletr)
    ...
    ternary_prob_matrix_all_0_1_out = sprintf("/fs/project/kubatko.2-temp/gao.957/workspace/github_MO/Figures3_4_Scenarios1_2/Scenario1_result/MO_Ternary_20missing/Ternary_alpha0%s_beta0%s_result/all_ternary_prob_matrix_all_0_1_out_matrix%s.csv",alpha_str,beta_str,indexn)
