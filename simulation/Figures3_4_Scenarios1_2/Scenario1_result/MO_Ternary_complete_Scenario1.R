...
for(parameterIndex in 1:dim(parameter_setting)[1]){
  ...
  ternary_folder_form = sprintf('/fs/project/kubatko.2-temp/gao.957/workspace/github_MO/Figures3_4_Scenarios1_2/Scenario1_result/MO_Ternary/Ternary_alpha0%s_beta0%s_result',alpha_str, beta_str)
  ...
  for (indexn in 1:1000){
    ...
    obs_form = sprintf('/fs/project/kubatko.2-temp/gao.957/workspace/github_MO/Figures3_4_Scenarios1_2/Scenario1/SimulateData_New/Ternary_alpha0%s_beta0%s/ternary_obs_0_1_tip_alpha_0%s_beta_0%s_matrix%s.csv', alpha_str, beta_str, alpha_str, beta_str,indexn)
    ...
    ternary_prob_matrix_all_0_1_out = sprintf("/fs/project/kubatko.2-temp/gao.957/workspace/github_MO/Figures3_4_Scenarios1_2/Scenario1_result/MO_Ternary/Ternary_alpha0%s_beta0%s_result/all_ternary_prob_matrix_all_0_1_out_matrix%s.csv",alpha_str,beta_str,indexn)
