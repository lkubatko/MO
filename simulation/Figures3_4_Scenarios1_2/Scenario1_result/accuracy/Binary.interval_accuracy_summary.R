...
for (indexn in 1:1000){
  ...
  prob_form_0_1 = sprintf('Binary_alpha0%s_beta0%s_result/binary_prob_matrix_all_0_1_out_alpha_0%s_beta_0%s_matrix%s.csv', alpha_str, beta_str, alpha_str, beta_str,indexn)
...
prob_cat_list_0_1_out = sprintf('/fs/project/kubatko.2-temp/gao.957/DNA_alignment/bowtie2-2.3.4.2-linux-x86_64/reference/Simulation_Setting/SimulateData/Binary_Summary/binary_interval_prob_cat_list_dat_0_1_out_alpha_0%s_beta_0%s_matrix.csv', alpha_str, beta_str)
