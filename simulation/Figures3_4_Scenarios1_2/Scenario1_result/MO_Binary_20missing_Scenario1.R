...
for(parameterIndex in 1:dim(parameter_setting)[1]){
  ...
  binary_folder_form = sprintf('/fs/project/kubatko.2-temp/gao.957/workspace/github_MO/Figures3_4_Scenarios1_2/Scenario1_result/MO_Binary_20missing/Binary_alpha0%s_beta0%s_result',alpha_str, beta_str)
  ...
  for (indexn in 1:1000){
    ...
    obs_form = sprintf('/fs/project/kubatko.2-temp/gao.957/workspace/github_MO/Figures3_4_Scenarios1_2/Scenario1/SimulateData_New_20Missing/Binary_alpha0%s_beta0%s/binary_obs_0_1_tip_alpha_0%s_beta_0%s_matrix%s.csv', alpha_str, beta_str, alpha_str, beta_str,indexn)
    ...
    binary_prob_matrix_all_0_1_out = sprintf("/fs/project/kubatko.2-temp/gao.957/workspace/github_MO/Figures3_4_Scenarios1_2/Scenario1_result/MO_Binary_20missing/Binary_alpha0%s_beta0%s_result/all_binary_prob_matrix_all_0_1_out_matrix%s.csv",alpha_str,beta_str,indexn)
