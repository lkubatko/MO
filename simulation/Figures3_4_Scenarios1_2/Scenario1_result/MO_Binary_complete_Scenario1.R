...
for(parameterIndex in 1:dim(parameter_setting)[1]){
  ...
  for (indexn in 1:1000){
    ...
    binary_prob_matrix_all_0_1_out = sprintf("/fs/project/kubatko.2-temp/gao.957/workspace/github_MO/Figures3_4_Scenarios1_2/Scenario1_result/MO_Binary/Binary_alpha0%s_beta0%s_result/all_binary_prob_matrix_all_0_1_out_matrix%s.csv",alpha_str,beta_str,indexn)
