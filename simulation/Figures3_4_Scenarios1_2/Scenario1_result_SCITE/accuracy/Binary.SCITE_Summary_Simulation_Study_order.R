...
for (indexn in 1:100){
  ...
  scite_order_form_0_1 = sprintf('/fs/project/kubatko.2-temp/gao.957/DNA_alignment/bowtie2-2.3.4.2-linux-x86_64/reference/Simulation_Setting/New_SCITE_SimulateData/SCITE_binary_alpha_0%s_beta_0%s/sub_binary_obs_0_1_tip_alpha_0%s_beta_0%s_node_order_%s.txt',alpha_str, beta_str, alpha_str, beta_str,indexn)
...
scite_near_pair_result_form_0_1 = sprintf('/fs/project/kubatko.2-temp/gao.957/DNA_alignment/bowtie2-2.3.4.2-linux-x86_64/reference/Simulation_Setting/New_SCITE_SimulateData/Binary_Summary/binary_near_order_matrix_01_0_1_out_alpha_0%s_beta_0%s.csv', alpha_str, beta_str, alpha_str, beta_str)
