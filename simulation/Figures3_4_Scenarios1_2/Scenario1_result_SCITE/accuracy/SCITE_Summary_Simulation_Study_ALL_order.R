...
scite_all_pair_result_form_0_1 = sprintf('/fs/project/kubatko.2-temp/gao.957/DNA_alignment/bowtie2-2.3.4.2-linux-x86_64/reference/Simulation_Setting/SCITE_SimulateData/Ternary_Summary/ternary_ALL_order_matrix_01_0_1_out_alpha_0%s_beta_0%s.csv', alpha_str, beta_str, alpha_str, beta_str)
