...
for (parameter in 1:dim(parameter_setting)[1]){
  ...
  binary_folder_form_10 = sprintf('/fs/project/kubatko.2-temp/gao.957/workspace/github_MO/Figures3_4_Scenarios1_2/Scenario2/SimulateData_New_10Missing_EXP10/Binary_alpha0%s_beta0%s',alpha_str, beta_str)
  ternary_folder_form_10 = sprintf('/fs/project/kubatko.2-temp/gao.957/workspace/github_MO/Figures3_4_Scenarios1_2/Scenario2/SimulateData_New_10Missing_EXP10/Ternary_alpha0%s_beta0%s',alpha_str, beta_str)
  
  
  dir.create(binary_folder_form_10)
  dir.create(ternary_folder_form_10)
  
  binary_folder_form_20 = sprintf('/fs/project/kubatko.2-temp/gao.957/workspace/github_MO/Figures3_4_Scenarios1_2/Scenario2/SimulateData_New_20Missing_EXP10/Binary_alpha0%s_beta0%s',alpha_str, beta_str)
  ternary_folder_form_20 = sprintf('/fs/project/kubatko.2-temp/gao.957/workspace/github_MO/Figures3_4_Scenarios1_2/Scenario2/SimulateData_New_20Missing_EXP10/Ternary_alpha0%s_beta0%s',alpha_str, beta_str)
  ...
  for (indexn in 1:1000){
    ...
    #read complete data
    binary_transformed_obs_dat_out = sprintf('/fs/project/kubatko.2-temp/gao.957/workspace/github_MO/Figures3_4_Scenarios1_2/Scenario2/SimulateData_New_EXP10/Binary_alpha0%s_beta0%s/binary_obs_0_1_tip_alpha_0%s_beta_0%s_matrix%s.csv', alpha_str, beta_str, alpha_str, beta_str,indexn)
    
    transformed_obs_dat_Binary = read.csv(file = binary_transformed_obs_dat_out)
    
    ternary_transformed_obs_dat_out = sprintf('/fs/project/kubatko.2-temp/gao.957/workspace/github_MO/Figures3_4_Scenarios1_2/Scenario2/SimulateData_New_EXP10/Ternary_alpha0%s_beta0%s/ternary_obs_0_1_tip_alpha_0%s_beta_0%s_matrix%s.csv', alpha_str, beta_str, alpha_str, beta_str,indexn)
    ...
    binary_transformed_obs_dat_out_10Missing = sprintf('/fs/project/kubatko.2-temp/gao.957/workspace/github_MO/Figures3_4_Scenarios1_2/Scenario2/SimulateData_New_10Missing_EXP10/Binary_alpha0%s_beta0%s/binary_obs_0_1_tip_alpha_0%s_beta_0%s_matrix%s.csv', alpha_str, beta_str, alpha_str, beta_str,indexn)
    
    write.csv(transformed_obs_dat_Binary_10Missing,file = binary_transformed_obs_dat_out_10Missing)
    
    ternary_transformed_obs_dat_out_10Missing = sprintf('/fs/project/kubatko.2-temp/gao.957/workspace/github_MO/Figures3_4_Scenarios1_2/Scenario2/SimulateData_New_10Missing_EXP10/Ternary_alpha0%s_beta0%s/ternary_obs_0_1_tip_alpha_0%s_beta_0%s_matrix%s.csv', alpha_str, beta_str, alpha_str, beta_str,indexn)
    
    write.csv(transformed_obs_dat_Ternary_10Missing,file = ternary_transformed_obs_dat_out_10Missing)
    
    #save 20 percent missing
    binary_transformed_obs_dat_out_20Missing = sprintf('/fs/project/kubatko.2-temp/gao.957/workspace/github_MO/Figures3_4_Scenarios1_2/Scenario2/SimulateData_New_20Missing_EXP10/Binary_alpha0%s_beta0%s/binary_obs_0_1_tip_alpha_0%s_beta_0%s_matrix%s.csv', alpha_str, beta_str, alpha_str, beta_str,indexn)
    
    write.csv(transformed_obs_dat_Binary_20Missing,file = binary_transformed_obs_dat_out_20Missing)
    
    ternary_transformed_obs_dat_out_20Missing = sprintf('/fs/project/kubatko.2-temp/gao.957/workspace/github_MO/Figures3_4_Scenarios1_2/Scenario2/SimulateData_New_20Missing_EXP10/Ternary_alpha0%s_beta0%s/ternary_obs_0_1_tip_alpha_0%s_beta_0%s_matrix%s.csv', alpha_str, beta_str, alpha_str, beta_str,indexn)
