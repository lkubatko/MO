...
setwd('/fs/project/kubatko.2-temp/gao.957/workspace/github_MO/Figures3_4_Scenarios1_2/Scenario1/SimulateData_New')
...
for (indexn in 1:1000){
  ...
  form_0_1 = sprintf('/fs/project/kubatko.2-temp/gao.957/workspace/github_MO/Figures3_4_Scenarios1_2/Scenario1/SimulateData_New/Obs_0_1_alpha0%s_beta0%s/true_0_1_tip_alpha_0%s_beta_0%s_matrix%s.Rdata', alpha_str, beta_str, alpha_str, beta_str,indexn)
  form_0_2 = sprintf('/fs/project/kubatko.2-temp/gao.957/workspace/github_MO/Figures3_4_Scenarios1_2/Scenario1/SimulateData_New/Obs_0_2_alpha0%s_beta0%s/true_0_2_tip_alpha_0%s_beta_0%s_matrix%s.Rdata', alpha_str, beta_str, alpha_str, beta_str,indexn)
  form_0_1_2= sprintf('/fs/project/kubatko.2-temp/gao.957/workspace/github_MO/Figures3_4_Scenarios1_2/Scenario1/SimulateData_New/Obs_0_1_2_alpha0%s_beta0%s/true_0_1_2_tip_alpha_0%s_beta_0%s_matrix%s.Rdata', alpha_str, beta_str, alpha_str, beta_str,indexn)
