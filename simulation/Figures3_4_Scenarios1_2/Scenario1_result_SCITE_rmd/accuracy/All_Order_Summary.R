...
if(missingindex==0){
  ...
  individual_res = sprintf("/fs/project/kubatko.2-temp/gao.957/workspace/github_MO/Figures3_4_Scenarios1_2/Scenario1_result_SCITE/SCITE_%s/summary/%s_all_order_alpha_0%s_beta_0%s_Fixed.csv",genotype,genotype_lowercase,alpha_str,beta_str)
  
}else{
  
  individual_res = sprintf("/fs/project/kubatko.2-temp/gao.957/workspace/github_MO/Figures3_4_Scenarios1_2/Scenario1_result_SCITE/SCITE_%s_%smissing/summary/%s_all_order_alpha_0%s_beta_0%s.csv",genotype,missingindex,genotype_lowercase,alpha_str,beta_str)
...
all_pair_result_form_0_1 = sprintf('/fs/project/kubatko.2-temp/gao.957/workspace/github_MO/Figures3_4_Scenarios1_2/Scenario1_result_SCITE/accuracy/scenario1_all_order_accuracy_Fixed.csv')
