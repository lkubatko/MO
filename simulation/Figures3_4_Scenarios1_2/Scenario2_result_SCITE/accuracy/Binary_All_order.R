...
for (indexn in 1:1000){
  ...
  scite_order_form_0_1 = sprintf('/fs/project/kubatko.2-temp/gao.957/workspace/github_MO/Figures3_4_Scenarios1_2/Scenario2_result_SCITE/SCITE_Binary/SCITE_binary_alpha_0%s_beta_0%s_Fixed/sub_binary_obs_0_1_tip_alpha_0%s_beta_0%s_node_order_%s.txt',alpha_str, beta_str, alpha_str, beta_str,indexn)
...
scite_all_pair_result_form_0_1 = sprintf('/fs/project/kubatko.2-temp/gao.957/workspace/github_MO/Figures3_4_Scenarios1_2/Scenario2_result_SCITE/SCITE_Binary/summary/binary_all_order_alpha_0%s_beta_0%s_Fixed.csv', alpha_str, beta_str)
