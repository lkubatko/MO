...
sifit_near_pair_result_form_0_1 = sprintf('./Figures3_4_Scenarios1_2/Scenario2_result_SiFit_rmd/SiFit_SimulateData/summary/binary_near_order_matrix_alpha_0%s_beta_0%s.csv', alpha_str, beta_str)
...
colnames(sifit_near_pair_result)=c("matched_paired","inferred_paired","true_pair","sifit_pair")
sifit_near_pair_result_form_0_1 = sprintf('./Figures3_4_Scenarios1_2/Scenario2_result_SiFit_rmd/SiFit_SimulateData_10missing/summary/binary_near_order_matrix_alpha_0%s_beta_0%s.csv', alpha_str, beta_str)
write.csv(sifit_near_pair_result,file=sifit_near_pair_result_form_0_1)
...
colnames(sifit_near_pair_result)=c("matched_paired","inferred_paired","true_pair","sifit_pair")
sifit_near_pair_result_form_0_1 = sprintf('./Figures3_4_Scenarios1_2/Scenario2_result_SiFit_rmd/SiFit_SimulateData_20missing/summary/binary_near_order_matrix_alpha_0%s_beta_0%s.csv', alpha_str, beta_str)
write.csv(sifit_near_pair_result,file=sifit_near_pair_result_form_0_1)
