...
for (indexn in 1:100){
  ...
  sifit_tree_form_0_1 = sprintf('./Figures3_4_Scenarios1_2/Scenario2/RandomTree/RandomTree_%s.tre', indexn)
  mat_sifit_tree_form_0_1 = read.tree(sifit_tree_form_0_1)
  
  sifit_br_form_0_1 = sprintf('./Figures3_4_Scenarios1_2/Scenario2_result_SiFit_rmd/SiFit_SimulateData/SiFit_binary_alpha_0%s_beta_0%s_TrueTree/TrueTree_outcome_order_alpha_0%s_beta_0%s_matrix%s.txt.in.txt',alpha_str, beta_str, alpha_str, beta_str,indexn)
  mat_sifit_br_form_0_1 = read.csv(sifit_br_form_0_1,sep="\t",header=FALSE)
  
  sifit_order_form_0_1 = sprintf('./Figures3_4_Scenarios1_2/Scenario2_result_SiFit_rmd/SiFit_SimulateData/SiFit_binary_alpha_0%s_beta_0%s_TrueTree/TrueTree_outcome_order_alpha_0%s_beta_0%s_matrix%s.txt.par_child.txt',alpha_str, beta_str, alpha_str, beta_str,indexn)
...
sifit_all_pair_result_form_0_1 = sprintf('./Figures3_4_Scenarios1_2/Scenario2_result_SiFit_rmd/SiFit_SimulateData/summary/binary_ALL_order_matrix_alpha_0%s_beta_0%s.csv', alpha_str, beta_str)
...
for (indexn in 1:100){
  ...
  sifit_br_form_0_1 = sprintf('./Figures3_4_Scenarios1_2/Scenario2_result_SiFit_rmd/SiFit_SimulateData_10missing/SiFit_binary_alpha_0%s_beta_0%s_TrueTree/TrueTree_outcome_order_alpha_0%s_beta_0%s_matrix%s.txt.in.txt',alpha_str, beta_str, alpha_str, beta_str,indexn)
  mat_sifit_br_form_0_1 = read.csv(sifit_br_form_0_1,sep="\t",header=FALSE)
  
  sifit_order_form_0_1 = sprintf('./Figures3_4_Scenarios1_2/Scenario2_result_SiFit_rmd/SiFit_SimulateData_10missing/SiFit_binary_alpha_0%s_beta_0%s_TrueTree/TrueTree_outcome_order_alpha_0%s_beta_0%s_matrix%s.txt.par_child.txt',alpha_str, beta_str, alpha_str, beta_str,indexn)
...
colnames(sifit_all_pair_result)=c("matched_paired","inferred_paired","true_pair","sifit_pair")
sifit_all_pair_result_form_0_1 = sprintf('./Figures3_4_Scenarios1_2/Scenario2_result_SiFit_rmd/SiFit_SimulateData_10missing/summary/binary_ALL_order_matrix_alpha_0%s_beta_0%s.csv', alpha_str, beta_str)
write.csv(sifit_all_pair_result,file=sifit_all_pair_result_form_0_1)
}
########################################################################
...
for (indexn in 1:100){
  ...
  sifit_br_form_0_1 = sprintf('./Figures3_4_Scenarios1_2/Scenario2_result_SiFit_rmd/SiFit_SimulateData_20missing/SiFit_binary_alpha_0%s_beta_0%s_TrueTree/TrueTree_outcome_order_alpha_0%s_beta_0%s_matrix%s.txt.in.txt',alpha_str, beta_str, alpha_str, beta_str,indexn)
  mat_sifit_br_form_0_1 = read.csv(sifit_br_form_0_1,sep="\t",header=FALSE)
  
  sifit_order_form_0_1 = sprintf('./Figures3_4_Scenarios1_2/Scenario2_result_SiFit_rmd/SiFit_SimulateData_20missing/SiFit_binary_alpha_0%s_beta_0%s_TrueTree/TrueTree_outcome_order_alpha_0%s_beta_0%s_matrix%s.txt.par_child.txt',alpha_str, beta_str, alpha_str, beta_str,indexn)
...
colnames(sifit_all_pair_result)=c("matched_paired","inferred_paired","true_pair","sifit_pair")
sifit_all_pair_result_form_0_1 = sprintf('./Figures3_4_Scenarios1_2/Scenario2_result_SiFit_rmd/SiFit_SimulateData_20missing/summary/binary_ALL_order_matrix_alpha_0%s_beta_0%s.csv', alpha_str, beta_str)
write.csv(sifit_all_pair_result,file=sifit_all_pair_result_form_0_1)
}
