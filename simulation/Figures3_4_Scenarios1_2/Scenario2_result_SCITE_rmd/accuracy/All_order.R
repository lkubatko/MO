...
for (indexn in 1:100){
  ...
  #read true tree
  form = sprintf('./Figures3_4_Scenarios1_2/Scenario2/RandomTree/RandomTree_%s.tre', indexn)
  sampletr=read.tree(form)
  
  #read inferred results
  scite_order_form_0_1 = sprintf('./Figures3_4_Scenarios1_2/Scenario2_result_SCITE_rmd/SCITE_Binary/SCITE_binary_alpha_0%s_beta_0%s_Fixed/sub_binary_obs_0_1_tip_alpha_0%s_beta_0%s_node_order_%s.txt',alpha_str, beta_str, alpha_str, beta_str,indexn)
...
scite_all_pair_result_form_0_1 = sprintf('./Figures3_4_Scenarios1_2/Scenario2_result_SCITE_rmd/SCITE_Binary/summary/binary_all_order_alpha_0%s_beta_0%s_Fixed.csv', alpha_str, beta_str)
...
for (indexn in 1:100){
  ...
  #read inferred results
  scite_order_form_0_1 = sprintf('./Figures3_4_Scenarios1_2/Scenario2_result_SCITE_rmd/SCITE_Binary_10missing/SCITE_binary_alpha_0%s_beta_0%s/sub_binary_obs_0_1_tip_alpha_0%s_beta_0%s_node_order_%s.txt',alpha_str, beta_str, alpha_str, beta_str,indexn)
  mat_scite_order_form_0_1 = scan(file=scite_order_form_0_1) 
  root_tree=mat_scite_order_form_0_1[1] #find the root
  root_index=which(mat_scite_order_form_0_1%in% root_tree ) #find the position of the root
...
colnames(scite_all_pair_result)=c("matched_paired","inferred_paired","true_pair")
scite_all_pair_result_form_0_1 = sprintf('./Figures3_4_Scenarios1_2/Scenario2_result_SCITE_rmd/SCITE_Binary_10missing/summary/binary_all_order_alpha_0%s_beta_0%s.csv', alpha_str, beta_str)
write.csv(scite_all_pair_result,file=scite_all_pair_result_form_0_1)
...
for (indexn in 1:100){
  ...
  #read inferred results
  scite_order_form_0_1 = sprintf('./Figures3_4_Scenarios1_2/Scenario2_result_SCITE_rmd/SCITE_Binary_20missing/SCITE_binary_alpha_0%s_beta_0%s/sub_binary_obs_0_1_tip_alpha_0%s_beta_0%s_node_order_%s.txt',alpha_str, beta_str, alpha_str, beta_str,indexn)
  mat_scite_order_form_0_1 = scan(file=scite_order_form_0_1) 
  root_tree=mat_scite_order_form_0_1[1] #find the root
  root_index=which(mat_scite_order_form_0_1%in% root_tree ) #find the position of the root
...
colnames(scite_all_pair_result)=c("matched_paired","inferred_paired","true_pair")
scite_all_pair_result_form_0_1 = sprintf('./Figures3_4_Scenarios1_2/Scenario2_result_SCITE_rmd/SCITE_Binary_20missing/summary/binary_all_order_alpha_0%s_beta_0%s.csv', alpha_str, beta_str)
write.csv(scite_all_pair_result,file=scite_all_pair_result_form_0_1)
...
for (indexn in 1:100){
  ...
  scite_order_form_0_1 = sprintf('./Figures3_4_Scenarios1_2/Scenario2_result_SCITE_rmd/SCITE_Ternary/SCITE_ternary_alpha_0%s_beta_0%s_Fixed/sub_obs_0_1_tip_alpha_0%s_beta_0%s_node_order_%s.txt',alpha_str, beta_str, alpha_str, beta_str,indexn)
  mat_scite_order_form_0_1 = scan(file=scite_order_form_0_1) 
...
colnames(scite_all_pair_result)=c("matched_paired","inferred_paired","true_pair")
scite_all_pair_result_form_0_1 = sprintf('./Figures3_4_Scenarios1_2/Scenario2_result_SCITE_rmd/SCITE_Ternary/summary/ternary_all_order_alpha_0%s_beta_0%s_Fixed.csv', alpha_str, beta_str)
write.csv(scite_all_pair_result,file=scite_all_pair_result_form_0_1)
}
...
for (indexn in 1:100){
  ...
  scite_order_form_0_1 = sprintf('./Figures3_4_Scenarios1_2/Scenario2_result_SCITE_rmd/SCITE_Ternary_10missing/SCITE_ternary_alpha_0%s_beta_0%s/sub_obs_0_1_tip_alpha_0%s_beta_0%s_node_order_%s.txt',alpha_str, beta_str, alpha_str, beta_str,indexn)
  mat_scite_order_form_0_1 = scan(file=scite_order_form_0_1) 
  root_tree=mat_scite_order_form_0_1[1]
  root_index=which(mat_scite_order_form_0_1%in% root_tree)
...
colnames(scite_all_pair_result)=c("matched_paired","inferred_paired","true_pair")
scite_all_pair_result_form_0_1 = sprintf('./Figures3_4_Scenarios1_2/Scenario2_result_SCITE_rmd/SCITE_Ternary_10missing/summary/ternary_all_order_alpha_0%s_beta_0%s.csv', alpha_str, beta_str)
write.csv(scite_all_pair_result,file=scite_all_pair_result_form_0_1)
}
...
for (indexn in 1:100){
  ...
  scite_order_form_0_1 = sprintf('./Figures3_4_Scenarios1_2/Scenario2_result_SCITE_rmd/SCITE_Ternary_20missing/SCITE_ternary_alpha_0%s_beta_0%s/sub_obs_0_1_tip_alpha_0%s_beta_0%s_node_order_%s.txt',alpha_str, beta_str, alpha_str, beta_str,indexn)
  mat_scite_order_form_0_1 = scan(file=scite_order_form_0_1) 
  root_tree=mat_scite_order_form_0_1[1]
  root_index=which(mat_scite_order_form_0_1%in% root_tree)
...
colnames(scite_all_pair_result)=c("matched_paired","inferred_paired","true_pair")
scite_all_pair_result_form_0_1 = sprintf('./Figures3_4_Scenarios1_2/Scenario2_result_SCITE_rmd/SCITE_Ternary_20missing/summary/ternary_all_order_alpha_0%s_beta_0%s.csv', alpha_str, beta_str)
write.csv(scite_all_pair_result,file=scite_all_pair_result_form_0_1)
}
