...
for(paraInd in 1:dim(parameter_setting)[1]){
  ...
  for (indexn in 1:100){
    ...
    binary_prob_matrix_all_0_1_out = sprintf("/fs/project/kubatko.2-temp/gao.957/workspace/cellcoal-master/cellcoal_10tips/MO_Binary/Binary_alpha0%s_beta0%s_%s_result/all_binary_prob_matrix_all_0_1_out_matrix%s_lostrate02_k1_multinomial.csv",alpha_str,alpha_str,numSites,indexn)
...
write.csv(All_loc_dat,file="/fs/project/kubatko.2-temp/gao.957/workspace/cellcoal-master/cellcoal_10tips/MO_Binary/All_MO_binary_location_accuracy_lostrate02_k1_multinomial.csv")
