...
for(paraInd in 11:11){
  ...
  for (indexn in 1:100){
    ...
    obs_ternary_folder_form_result_br = sprintf("/fs/project/kubatko.2-temp/gao.957/workspace/cellcoal-master/cellcoal_50tips/results_alpha_0%s_beta_0%s_%s/snv_haplotypes_dir/br_collapsed_snv_hap%s_lostrate02_k2.csv",alpha_str,alpha_str,numSites,indexn)
    ...
    ternary_prob_matrix_all_0_1_2_out = sprintf("/fs/project/kubatko.2-temp/gao.957/workspace/cellcoal-master/cellcoal_50tips/MO_Ternary/Ternary_alpha0%s_beta0%s_%s_result/all_ternary_prob_matrix_all_0_1_2_out_matrix%s_lostrate02_k2.csv",alpha_str,alpha_str,numSites,indexn)
...
write.csv(All_loc_dat,file="/fs/project/kubatko.2-temp/gao.957/workspace/cellcoal-master/cellcoal_50tips/MO_Ternary/All_MO_Ternary_location_accuracy_lostrate02_k2.csv")
