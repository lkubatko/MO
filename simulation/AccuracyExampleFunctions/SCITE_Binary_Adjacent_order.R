...
scite_near_pair_result_form_0_1 = sprintf('/fs/project/kubatko.2-temp/gao.957/workspace/github_MO/Figures3_4_Scenarios1_2/Scenario1_result_SCITE/SCITE_Binary/summary/binary_adjacent_order_alpha_0%s_beta_0%s_Fixed.csv', alpha_str, beta_str)
