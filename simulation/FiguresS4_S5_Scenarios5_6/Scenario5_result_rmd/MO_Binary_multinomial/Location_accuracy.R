...
for (indexn in 1:100){
  ...
  if (missingindex == 0){
    ...
    prob_form_0_1 = sprintf("/fs/project/kubatko.2-temp/gao.957/workspace/github_MO/MO/simulation/FiguresS4_S5_Scenarios5_6/Scenario5_result_rmd/MO_Binary_multinomial/Binary_alpha0%s_beta0%s_%s_result/all_binary_prob_matrix_all_0_1_out_matrix%s_multinomial.csv",alpha_str,alpha_str,numSites,indexn)
    
  }else{
    
    prob_form_0_1 = sprintf("/fs/project/kubatko.2-temp/gao.957/workspace/github_MO/MO/simulation/FiguresS4_S5_Scenarios5_6/Scenario5_result_rmd/MO_Binary_multinomial/Binary_alpha0%s_beta0%s_%s_result/all_binary_prob_matrix_all_0_1_out_matrix%s_%s_multinomial.csv",alpha_str,alpha_str,numSites,indexn,missingindex)
...
prob_cat_list_0_1_out = sprintf('/fs/project/kubatko.2-temp/gao.957/workspace/github_MO/MO/simulation/FiguresS4_S5_Scenarios5_6/Scenario5_result_rmd/MO_Binary_multinomial/summary/binary_location_alpha_0%s_beta_0%s_%s_%smissing.csv', alpha_str, beta_str,numSites,missingindex)
...
for(parameterindex in 1:dim(parameter_setting)[1]){
  ...
  if(missingindex==0){
    ...
    individual_res = sprintf("./FiguresS4_S5_Scenarios5_6/Scenario5_result_rmd/MO_Binary_multinomial/summary/%s_location_alpha_0%s_beta_0%s_%s_0missing.csv",genotype_lowercase,alpha_str,beta_str,numSites)
    
  }else if(missingindex==10){
    
    individual_res = sprintf("./FiguresS4_S5_Scenarios5_6/Scenario5_result_rmd/MO_Binary_multinomial/summary/%s_location_alpha_0%s_beta_0%s_%s_10missing.csv",genotype_lowercase,alpha_str,beta_str,numSites)
    
  }else{
    
    individual_res = sprintf("./FiguresS4_S5_Scenarios5_6/Scenario5_result_rmd/MO_Binary_multinomial/summary/%s_location_alpha_0%s_beta_0%s_%s_20missing.csv",genotype_lowercase,alpha_str,beta_str,numSites)
...
all_pair_result_form_0_1 = sprintf('./FiguresS4_S5_Scenarios5_6/Scenario5_result_rmd/accuracy/scenario5_location_accuracy_multinomial.csv')
