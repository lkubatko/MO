...
for (indexn in 1:100){
  ...
  if (missingindex == 0){
    ...
    prob_form_0_1 = sprintf("./FiguresS4_S5_Scenarios5_6/Scenario5_result_rmd/MO_Ternary/Ternary_alpha0%s_beta0%s_%s_result/all_ternary_prob_matrix_all_0_1_2_out_matrix%s.csv",alpha_str,alpha_str,numSites,indexn)
    
  }else{
    
    prob_form_0_1 = sprintf("./FiguresS4_S5_Scenarios5_6/Scenario5_result_rmd/MO_Ternary/Ternary_alpha0%s_beta0%s_%s_result/all_ternary_prob_matrix_all_0_1_out_matrix%s_%s.csv",alpha_str,alpha_str,numSites,indexn,missingindex)
...
all_pair_result_form_0_1_sub = sprintf('./FiguresS4_S5_Scenarios5_6/Scenario5_result_rmd/MO_Ternary/summary/ternary_all_alpha_0%s_beta_0%s_%s.csv',alpha_str,alpha_str,numSites)
