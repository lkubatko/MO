...
all_pair_result_form_0_1_sub = sprintf('./FiguresS4_S5_Scenarios5_6/Scenario5_result_rmd/MO_Binary/summary/binary_all_alpha_0%s_beta_0%s_%s.csv',alpha_str,alpha_str,numSites)
