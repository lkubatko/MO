...
for (indexn in 1:100){
  ...
  all_pair_result[indexn,]=c(dim(unique_all_match_near_branch_sub)[1],dim(unique_all_true_match_near_branch_sub)[1],numSites,alpha,missingindex,Genotype="Ternary",lost_rate=0,lost_br=0,Method="MO")
...
all_pair_result_form_0_1_sub = sprintf('./FiguresS4_S5_Scenarios5_6/Scenario6_result_rmd/MO_Ternary/summary/ternary_adjacent_order_alpha_0%s_beta_0%s_%s.csv',alpha_str,alpha_str,numSites)
