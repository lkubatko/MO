...
source("/fs/project/kubatko.2-temp/gao.957/workspace/github_MO/MO/code/code_MO_binary_function.R")
...
for(paraInd in 1:dim(parameter_setting)[1]){
  ...
  binary_folder_form_result = sprintf('/fs/project/kubatko.2-temp/gao.957/workspace/github_MO/MO/simulation/FiguresS4_S5_Scenarios5_6/Scenario6_result_rmd/MO_Binary/Binary_alpha0%s_beta0%s_%s_result',alpha_str, beta_str,numSites)
  ...
  for (indexn in 1:100){
    ...
    binary_prob_matrix_all_0_1_out = sprintf("/fs/project/kubatko.2-temp/gao.957/workspace/github_MO/MO/simulation/FiguresS4_S5_Scenarios5_6/Scenario6_result_rmd/MO_Binary/Binary_alpha0%s_beta0%s_%s_result/all_binary_prob_matrix_all_0_1_out_matrix%s.csv",alpha_str,alpha_str,numSites,indexn)
