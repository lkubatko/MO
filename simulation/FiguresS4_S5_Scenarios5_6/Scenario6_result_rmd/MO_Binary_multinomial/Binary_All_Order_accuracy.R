...
for (indexn in 1:100){
  ...
  if (missingindex == 0){
    ...
    prob_form_0_1 = sprintf("./FiguresS4_S5_Scenarios5_6/Scenario6_result_rmd/MO_Binary/Binary_alpha0%s_beta0%s_%s_result/all_binary_prob_matrix_all_0_1_out_matrix%s.csv",alpha_str,alpha_str,numSites,indexn)
    
  }else{
    
    prob_form_0_1 = sprintf("./FiguresS4_S5_Scenarios5_6/Scenario6_result_rmd/MO_Binary/Binary_alpha0%s_beta0%s_%s_result/all_binary_prob_matrix_all_0_1_out_matrix%s_%s.csv",alpha_str,alpha_str,numSites,indexn,missingindex)
  ...
  all_pair_result[indexn,]=c(dim(unique_all_match_all_branch_sub)[1],dim(unique_all_true_match_all_branch_sub)[1],numSites,alpha,missingindex,Genotype="Binary",lost_rate=0,lost_br=0,Method="MO")
...
all_pair_result_form_0_1_sub = sprintf('./FiguresS4_S5_Scenarios5_6/Scenario6_result_rmd/MO_Binary/summary/binary_all_alpha_0%s_beta_0%s_%s.csv',alpha_str,alpha_str,numSites)
