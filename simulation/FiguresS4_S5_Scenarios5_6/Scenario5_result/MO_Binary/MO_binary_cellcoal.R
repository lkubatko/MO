...
for(paraInd in 1:dim(parameter_setting)[1]){
  ...
  for (indexn in 100:100){
    ...
    binary_prob_matrix_all_0_1_out = sprintf("/fs/project/kubatko.2-temp/gao.957/workspace/cellcoal-master/cellcoal_10tips/MO_Binary/Binary_alpha0%s_beta0%s_%s_result/all_binary_prob_matrix_all_0_1_out_matrix%s.csv",alpha_str,alpha_str,numSites,indexn)
