...
binary_folder_form = sprintf('./FiguresS2_S3_Scenarios3_4/Scenario4_result_rmd/MO_Binary/Binary_alpha0%s_beta0%s_result',alpha_str, beta_str)
  ...
  for (indexn in 1:100){
    ...
    obs_form = sprintf('./FiguresS2_S3_Scenarios3_4/Scenario4/SimulateData/Binary_alpha0%s_beta0%s/binary_obs_0_1_tip_alpha_0%s_beta_0%s_matrix%s.csv', alpha_str, beta_str, alpha_str, beta_str,indexn)
...
for (indexn in 1:100){
  ...
  for (i in 1:dim(mat_prob_form_0_1)[1]){
    ...
    if(mat_prob_form_0_1$First_branch == mat_prob_form_0_1$selected_br){
...
adjacent_pair_result_form_0_1 = sprintf('./FiguresS2_S3_Scenarios3_4/Scenario4_result_rmd/MO_Binary/summary/binary_adjacent_order_alpha_0%s_beta_0%s.csv', alpha_str, beta_str)
...
adjacent_pair_result_form_0_1 = sprintf('./FiguresS2_S3_Scenarios3_4/Scenario4_result_rmd/MO_Ternary/summary/ternary_adjacent_order_alpha_0%s_beta_0%s.csv', alpha_str, beta_str)
write.csv(adjacent_pair_result,file=adjacent_pair_result_form_0_1)
...
if(missingindex==0){
  ...
  individual_res = sprintf("./FiguresS2_S3_Scenarios3_4/Scenario4_result/MO_%s_%smissing/summary/%s_interval_alpha_0%s_beta_0%s_matrix.csv",genotype,missingindex,genotype_lowercase,alpha_str,beta_str)
...
all_pair_result_form_0_1 = sprintf('./FiguresS2_S3_Scenarios3_4/Scenario4_result_rmd/accuracy/Scenario4_interval_accuracy.csv')
...
for(parameterindex in 1:dim(parameter_setting)[1]){
  ...
  if(missingindex==0){
    ...
    individual_res = sprintf("./FiguresS2_S3_Scenarios3_4/Scenario4_result/MO_%s/summary/%s_location_alpha_0%s_beta_0%s.csv",genotype,genotype_lowercase,alpha_str,beta_str)
    
  }else{
    
    individual_res = sprintf("./FiguresS2_S3_Scenarios3_4/Scenario4_result/MO_%s_%smissing/summary/%s_location_alpha_0%s_beta_0%s.csv",genotype,missingindex,genotype_lowercase,alpha_str,beta_str)
...
all_pair_result_form_0_1 = sprintf('./FiguresS2_S3_Scenarios3_4/Scenario4_result_rmd/accuracy/Scenario4_location_accuracy.csv')
write.csv(all_pair_result_dat,file=all_pair_result_form_0_1)
...
if(missingindex==0){
  ...
  individual_res = sprintf("./FiguresS2_S3_Scenarios3_4/Scenario4_result/MO_%s_%smissing/summary/%s_adjacent_order_alpha_0%s_beta_0%s.csv",genotype,missingindex,genotype_lowercase,alpha_str,beta_str)
...
all_pair_result_form_0_1 = sprintf('./FiguresS2_S3_Scenarios3_4/Scenario4_result_rmd/accuracy/Scenario4_adjacent_order_accuracy.csv')
write.csv(all_pair_result_dat,file=all_pair_result_form_0_1)
...
if(missingindex==0){
  ...
  individual_res = sprintf("./FiguresS2_S3_Scenarios3_4/Scenario4_result/MO_%s_%smissing/summary/%s_all_order_alpha_0%s_beta_0%s.csv",genotype,missingindex,genotype_lowercase,alpha_str,beta_str)
...
all_pair_result_form_0_1 = sprintf('./FiguresS2_S3_Scenarios3_4/Scenario4_result_rmd/accuracy/Scenario4_all_order_accuracy.csv')
write.csv(all_pair_result_dat,file=all_pair_result_form_0_1)
