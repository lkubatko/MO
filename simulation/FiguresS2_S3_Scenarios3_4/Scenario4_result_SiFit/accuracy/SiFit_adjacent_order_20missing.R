...
for (indexn in 1:100){
  ...
  sifit_tree_form_0_1 = sprintf('/fs/project/kubatko.2-temp/gao.957/DNA_alignment/bowtie2-2.3.4.2-linux-x86_64/reference/Simulation_Setting_LargeTree/SiFit_SimulateData_EXP10_20Missing/SiFit_binary_alpha_0%s_beta_0%s_TrueTree/True_sub_ternary_obs_0_1_tip_alpha_0%s_beta_0%s_matrix%s_mlTree.newick',alpha_str, beta_str, alpha_str, beta_str,indexn)
  mat_sifit_tree_form_0_1 = read.tree(sifit_tree_form_0_1)
  
  sifit_br_form_0_1 = sprintf('/fs/project/kubatko.2-temp/gao.957/DNA_alignment/bowtie2-2.3.4.2-linux-x86_64/reference/Simulation_Setting_LargeTree/SiFit_SimulateData_EXP10_20Missing/SiFit_binary_alpha_0%s_beta_0%s_TrueTree/TrueTree_outcome_order_alpha_0%s_beta_0%s_matrix%s.txt.in.txt',alpha_str, beta_str, alpha_str, beta_str,indexn)
  mat_sifit_br_form_0_1 = read.csv(sifit_br_form_0_1,sep="\t",header=FALSE)
  
  sifit_order_form_0_1 = sprintf('/fs/project/kubatko.2-temp/gao.957/DNA_alignment/bowtie2-2.3.4.2-linux-x86_64/reference/Simulation_Setting_LargeTree/SiFit_SimulateData_EXP10_20Missing/SiFit_binary_alpha_0%s_beta_0%s_TrueTree/TrueTree_outcome_order_alpha_0%s_beta_0%s_matrix%s.txt.par_child.txt',alpha_str, beta_str, alpha_str, beta_str,indexn)
...
sifit_near_pair_result_form_0_1 = sprintf('/fs/project/kubatko.2-temp/gao.957/DNA_alignment/bowtie2-2.3.4.2-linux-x86_64/reference/Simulation_Setting_LargeTree/SiFit_SimulateData_EXP10_20Missing/Binary_Summary/binary_near_order_matrix_01_0_1_out_alpha_0%s_beta_0%s.csv', alpha_str, beta_str)
