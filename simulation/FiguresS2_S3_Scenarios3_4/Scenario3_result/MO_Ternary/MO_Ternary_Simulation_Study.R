...
if (length(args) == 0){
  stop("Error: No alpha and beta values are given!/n", call.=FALSE)
} else {
...
ternary_folder_form_result = sprintf('/fs/project/kubatko.2-temp/gao.957/DNA_alignment/bowtie2-2.3.4.2-linux-x86_64/reference/Simulation_Setting_LargeTree/SimulateData/Ternary_alpha0%s_beta0%s_result',alpha_str, beta_str)
...
for (indexn in 1:100){
  ...
  obs_form_0_1_2 = sprintf('/fs/project/kubatko.2-temp/gao.957/DNA_alignment/bowtie2-2.3.4.2-linux-x86_64/reference/Simulation_Setting_LargeTree/SimulateData/Ternary_alpha0%s_beta0%s/ternary_obs_0_1_tip_alpha_0%s_beta_0%s_matrix%s.csv', alpha_str, beta_str, alpha_str, beta_str,indexn)
  ...
  if (dim(mat_obs_form_0_1_2)[1]>0){
    ...
    for (i in 1:dim(initial_obs_0_1)[1]){
      ...
      rd_unit_theta =  rgamma(n = 10, shape = 10, scale = 0.1*unit_theta)
      rd_unit_gamma = rgamma(10, shape = 10, scale = 0.1*unit_gamma)
      rd_unit_mu = rgamma(10, shape = 10, scale = 0.1*unit_mu)
      
      generate_prob_br_0_1_dat=data.frame(matrix(NA, nrow = number_br, ncol = 10))
      generate_prob_br_0_2_dat=data.frame(matrix(NA, nrow = number_br, ncol = 10))
      generate_prob_br_0_1_2_dat=data.frame(matrix(NA, nrow = number_br, ncol = 10))
      generate_prob_br_all_dat=data.frame(matrix(NA, nrow = number_br, ncol = 10))
  ...
  ternary_prob_matrix_all_0_1_2_out = sprintf('/fs/project/kubatko.2-temp/gao.957/DNA_alignment/bowtie2-2.3.4.2-linux-x86_64/reference/Simulation_Setting_LargeTree/SimulateData/Ternary_alpha0%s_beta0%s_result/ternary_prob_matrix_all_0_1_2_out_alpha_0%s_beta_0%s_matrix%s.csv', alpha_str, beta_str, alpha_str, beta_str,indexn)
  ternary_prob_matrix_01_0_1_2_out = sprintf('/fs/project/kubatko.2-temp/gao.957/DNA_alignment/bowtie2-2.3.4.2-linux-x86_64/reference/Simulation_Setting_LargeTree/SimulateData/Ternary_alpha0%s_beta0%s_result/ternary_prob_matrix_01_0_1_2_out_alpha_0%s_beta_0%s_matrix%s.csv', alpha_str, beta_str, alpha_str, beta_str,indexn)
  ternary_prob_matrix_02_0_1_2_out= sprintf('/fs/project/kubatko.2-temp/gao.957/DNA_alignment/bowtie2-2.3.4.2-linux-x86_64/reference/Simulation_Setting_LargeTree/SimulateData/Ternary_alpha0%s_beta0%s_result/ternary_prob_matrix_02_0_1_2_out_alpha_0%s_beta_0%s_matrix%s.csv', alpha_str, beta_str, alpha_str, beta_str,indexn)
  ternary_prob_matrix_012_0_1_2_out= sprintf('/fs/project/kubatko.2-temp/gao.957/DNA_alignment/bowtie2-2.3.4.2-linux-x86_64/reference/Simulation_Setting_LargeTree/SimulateData/Ternary_alpha0%s_beta0%s_result/ternary_prob_matrix_012_0_1_2_out_alpha_0%s_beta_0%s_matrix%s.csv', alpha_str, beta_str, alpha_str, beta_str,indexn)
