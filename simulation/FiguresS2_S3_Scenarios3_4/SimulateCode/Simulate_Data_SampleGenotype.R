...
binary_folder_form = sprintf('/fs/project/kubatko.2-temp/gao.957/DNA_alignment/bowtie2-2.3.4.2-linux-x86_64/reference/Simulation_Setting_LargeTree/SimulateData/Binary_alpha0%s_beta0%s',alpha_str, beta_str)
ternary_folder_form = sprintf('/fs/project/kubatko.2-temp/gao.957/DNA_alignment/bowtie2-2.3.4.2-linux-x86_64/reference/Simulation_Setting_LargeTree/SimulateData/Ternary_alpha0%s_beta0%s',alpha_str, beta_str)
...
for (indexn in 1:100){
  ...
  obs_form_0_1 = sprintf('/fs/project/kubatko.2-temp/gao.957/DNA_alignment/bowtie2-2.3.4.2-linux-x86_64/reference/Simulation_Setting_LargeTree/SimulateData/Obs_0_1_alpha0%s_beta0%s/obs_0_1_tip_alpha_0%s_beta_0%s_matrix%s.Rdata', alpha_str, beta_str, alpha_str, beta_str,indexn)
  obs_form_0_2 = sprintf('/fs/project/kubatko.2-temp/gao.957/DNA_alignment/bowtie2-2.3.4.2-linux-x86_64/reference/Simulation_Setting_LargeTree/SimulateData/Obs_0_2_alpha0%s_beta0%s/obs_0_2_tip_alpha_0%s_beta_0%s_matrix%s.Rdata', alpha_str, beta_str, alpha_str, beta_str,indexn)
  obs_form_0_1_2 = sprintf('/fs/project/kubatko.2-temp/gao.957/DNA_alignment/bowtie2-2.3.4.2-linux-x86_64/reference/Simulation_Setting_LargeTree/SimulateData/Obs_0_1_2_alpha0%s_beta0%s/obs_0_1_2_tip_alpha_0%s_beta_0%s_matrix%s.Rdata', alpha_str, beta_str, alpha_str, beta_str,indexn)
  ...
  binary_transformed_obs_dat_out_10 = sprintf('/fs/project/kubatko.2-temp/gao.957/DNA_alignment/bowtie2-2.3.4.2-linux-x86_64/reference/Simulation_Setting_LargeTree/SimulateData/Binary_alpha0%s_beta0%s/binary_obs_0_1_tip_alpha_0%s_beta_0%s_matrix%s.csv', alpha_str, beta_str, alpha_str, beta_str,indexn)
  
  write.csv(transformed_obs_dat_Binary,file = binary_transformed_obs_dat_out_10)
  
  ternary_transformed_obs_dat_out_10 = sprintf('/fs/project/kubatko.2-temp/gao.957/DNA_alignment/bowtie2-2.3.4.2-linux-x86_64/reference/Simulation_Setting_LargeTree/SimulateData/Ternary_alpha0%s_beta0%s/ternary_obs_0_1_tip_alpha_0%s_beta_0%s_matrix%s.csv', alpha_str, beta_str, alpha_str, beta_str,indexn)
