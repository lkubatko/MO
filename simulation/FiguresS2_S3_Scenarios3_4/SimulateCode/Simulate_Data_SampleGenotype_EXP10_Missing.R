...
for (paraind in 1:dim(parameter_setting)[1]){
  ...
  binary_folder_form_10 = sprintf('/fs/project/kubatko.2-temp/gao.957/DNA_alignment/bowtie2-2.3.4.2-linux-x86_64/reference/Simulation_Setting_LargeTree/SimulateData_EXP10_10Missing/Binary_alpha0%s_beta0%s',alpha_str, beta_str)
  ternary_folder_form_10 = sprintf('/fs/project/kubatko.2-temp/gao.957/DNA_alignment/bowtie2-2.3.4.2-linux-x86_64/reference/Simulation_Setting_LargeTree/SimulateData_EXP10_10Missing/Ternary_alpha0%s_beta0%s',alpha_str, beta_str)
  
  
  dir.create(binary_folder_form_10)
  dir.create(ternary_folder_form_10)
  
  binary_folder_form_20 = sprintf('/fs/project/kubatko.2-temp/gao.957/DNA_alignment/bowtie2-2.3.4.2-linux-x86_64/reference/Simulation_Setting_LargeTree/SimulateData_EXP10_20Missing/Binary_alpha0%s_beta0%s',alpha_str, beta_str)
  ternary_folder_form_20 = sprintf('/fs/project/kubatko.2-temp/gao.957/DNA_alignment/bowtie2-2.3.4.2-linux-x86_64/reference/Simulation_Setting_LargeTree/SimulateData_EXP10_20Missing/Ternary_alpha0%s_beta0%s',alpha_str, beta_str)
  ...
  for (indexn in 1:100){
    ...
    binary_transformed_obs_dat_out = sprintf('/fs/project/kubatko.2-temp/gao.957/DNA_alignment/bowtie2-2.3.4.2-linux-x86_64/reference/Simulation_Setting_LargeTree/SimulateData_EXP10/Binary_alpha0%s_beta0%s/binary_obs_0_1_tip_alpha_0%s_beta_0%s_matrix%s.csv', alpha_str, beta_str, alpha_str, beta_str,indexn)
    
    transformed_obs_dat_Binary = read.csv(file = binary_transformed_obs_dat_out)
    
    ternary_transformed_obs_dat_out = sprintf('/fs/project/kubatko.2-temp/gao.957/DNA_alignment/bowtie2-2.3.4.2-linux-x86_64/reference/Simulation_Setting_LargeTree/SimulateData_EXP10/Ternary_alpha0%s_beta0%s/ternary_obs_0_1_tip_alpha_0%s_beta_0%s_matrix%s.csv', alpha_str, beta_str, alpha_str, beta_str,indexn)
    ...
    #10 percent missing
    binary_transformed_obs_dat_out_10Missing = sprintf('/fs/project/kubatko.2-temp/gao.957/DNA_alignment/bowtie2-2.3.4.2-linux-x86_64/reference/Simulation_Setting_LargeTree/SimulateData_EXP10_10Missing/Binary_alpha0%s_beta0%s/binary_obs_0_1_tip_alpha_0%s_beta_0%s_matrix%s.csv', alpha_str, beta_str, alpha_str, beta_str,indexn)
    
    write.csv(transformed_obs_dat_Binary_10Missing,file = binary_transformed_obs_dat_out_10Missing)
    
    ternary_transformed_obs_dat_out_10Missing = sprintf('/fs/project/kubatko.2-temp/gao.957/DNA_alignment/bowtie2-2.3.4.2-linux-x86_64/reference/Simulation_Setting_LargeTree/SimulateData_EXP10_10Missing/Ternary_alpha0%s_beta0%s/ternary_obs_0_1_tip_alpha_0%s_beta_0%s_matrix%s.csv', alpha_str, beta_str, alpha_str, beta_str,indexn)
    
    write.csv(transformed_obs_dat_Ternary_10Missing,file = ternary_transformed_obs_dat_out_10Missing)
    
    #20 percent missing
    binary_transformed_obs_dat_out_20Missing = sprintf('/fs/project/kubatko.2-temp/gao.957/DNA_alignment/bowtie2-2.3.4.2-linux-x86_64/reference/Simulation_Setting_LargeTree/SimulateData_EXP10_20Missing/Binary_alpha0%s_beta0%s/binary_obs_0_1_tip_alpha_0%s_beta_0%s_matrix%s.csv', alpha_str, beta_str, alpha_str, beta_str,indexn)
    
    write.csv(transformed_obs_dat_Binary_20Missing,file = binary_transformed_obs_dat_out_20Missing)
    
    ternary_transformed_obs_dat_out_20Missing = sprintf('/fs/project/kubatko.2-temp/gao.957/DNA_alignment/bowtie2-2.3.4.2-linux-x86_64/reference/Simulation_Setting_LargeTree/SimulateData_EXP10_20Missing/Ternary_alpha0%s_beta0%s/ternary_obs_0_1_tip_alpha_0%s_beta_0%s_matrix%s.csv', alpha_str, beta_str, alpha_str, beta_str,indexn)
