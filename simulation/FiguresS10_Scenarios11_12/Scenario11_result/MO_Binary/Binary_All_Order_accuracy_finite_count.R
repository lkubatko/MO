...
all_pair_result_form_0_1_sub = sprintf('/fs/project/kubatko.2-temp/gao.957/workspace/cellcoal-master/cellcoal_10tips/MO_Binary/binary_all_order_matrix_01_0_1_out_finite_%s.csv',paraInd)
write.csv(all_pair_result,file=all_pair_result_form_0_1_sub)


}

all_pair_result_form_0_1 = sprintf('/fs/project/kubatko.2-temp/gao.957/workspace/cellcoal-master/cellcoal_10tips/MO_Binary/binary_all_order_matrix_01_0_1_out_finite.csv')
