...
for(paraInd in 1:dim(parameter_setting)[1]){
  ...
  prob_cat_list[indexn,] = cbind(sum(cat_list),dim(mat_prob_form_0_1)[1],numSites,alpha,m10,missingindex=0,Genotype="Ternary",lost_rate=0,lost_br=0,Method="MO")
...
prob_cat_list_0_1_out = sprintf('/fs/project/kubatko.2-temp/gao.957/workspace/cellcoal-master/cellcoal_10tips/MO_Ternary/ternary_location_accuracy_matrix_01_0_1_out_finite.csv')
