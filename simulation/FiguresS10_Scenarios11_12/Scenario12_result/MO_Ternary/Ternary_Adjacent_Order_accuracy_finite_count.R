...
for (indexn in 1:20){
  ...
  all_pair_result[indexn,]=c(dim(unique_all_match_near_branch_sub)[1],numSites,alpha,m10,missingindex=0,Genotype="Ternary",lost_rate=0,lost_br=0,Method="MO")
...
all_pair_result_form_0_1_sub = sprintf('/fs/project/kubatko.2-temp/gao.957/workspace/cellcoal-master/cellcoal_50tips/MO_Ternary/ternary_adjacent_order_matrix_01_0_1_out_finite_%s.csv',paraInd)
write.csv(all_pair_result,file=all_pair_result_form_0_1_sub)


}

all_pair_result_form_0_1 = sprintf('/fs/project/kubatko.2-temp/gao.957/workspace/cellcoal-master/cellcoal_50tips/MO_Ternary/ternary_adjacent_order_matrix_01_0_1_out_finite.csv')
