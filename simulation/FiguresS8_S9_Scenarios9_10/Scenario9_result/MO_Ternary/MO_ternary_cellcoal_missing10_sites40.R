...
for (indexn in 1:100){
  ...
  ternary_prob_matrix_all_0_1_2_out = sprintf("/fs/project/kubatko.2-temp/gao.957/DNA_alignment/bowtie2-2.3.4.2-linux-x86_64/reference/Simulation_Setting/MO_Ternary/Ternary_alpha0%s_beta0%s_%s_result/all_ternary_prob_matrix_all_0_1_2_out_matrix%s_10.csv",alpha_str,alpha_str,numSites,indexn)
...
write.csv(All_loc_dat,file="/fs/project/kubatko.2-temp/gao.957/DNA_alignment/bowtie2-2.3.4.2-linux-x86_64/reference/Simulation_Setting/MO_Ternary/All_MO_ternary_location_accuracy_10_sites40.csv")
